    ...
    >
        <div class="card-profile">
            <div class="card-profile-header">
                <div class="card-profile-title">Lengkapi Data Pribadi</div>
            </div>
                ...
                <div class="profile-layout">
                    <div class="profile-avatar">
                        ...
                        <div class="avatar-helper">
                            Lengkapi data diri anda dengan benar dan sesuai identitas.
                        </div>
                    </div>
                    <div class="profile-fields">
                        <form wire:submit.prevent="submitDataDiri" x-ref="dataForm">
                            <div class="field-grid">
                                <div>
                                    <div class="field-label">NIK</div>
                                    <input type="text" class="field-value" maxlength="16" wire:model.defer="formData.warga_nik">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <select
                                        class="field-select"
                                        wire:model.defer="formData.no_rt_id"
                                    >
                                        <option value="">Pilih</option>
                                        @foreach($rtOptions as $id => $nomor)
                                            <option value="{{ $id }}">RT {{ str_pad((string) $nomor, 3, '0', STR_PAD_LEFT) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <div class="field-label">No hp</div>
                                    <input type="text" class="field-value" maxlength="15" wire:model.defer="formData.no_hp" >
                                </div>
        ...
        >
            <div class="modal-card">
                <div class="modal-header">
                    ...
                    <div class="modal-title">Konfirmasi Penyimpanan Data</div>
                </div>
                <div class="modal-body">
                    ...
                    <p>
                        Data akan disimpan dan dikaitkan dengan akun anda.
                    </p>
                </div>
