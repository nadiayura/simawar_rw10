...
* Laporan pengaduan warga sering tidak terdokumentasi dan terlewat.
* Pembayaran iuran dan pencatatan kas RT/RW rentan terhadap kesalahan rekapitulasi dan duplikasi data.
* Informasi status permohonan surat maupun pengaduan tidak tersampaikan secara *real-time*.
